...
const TAB_SPRING = { duration: 400, dampingRatio: 0.82, mass: 0.8 } as const;
const ICON_BOUNCE = { duration: 480, dampingRatio: 0.65, mass: 0.7 } as const;
...
export function TabBar({ state, descriptors, navigation }: BottomTabBarProps) {
  ...
  return (
    ...
    >
      <GlassSurface intensity={50} radius={22} fill={theme.barFill} style={styles.dock}>
...
const styles = StyleSheet.create({
  ...
  dock: { height: layout.tabBarHeight, justifyContent: "center" },
  row: { flexDirection: "row", alignItems: "stretch", height: "100%" },
